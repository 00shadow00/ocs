...
rm /etc/sysctl.conf
wget -O /etc/openvpn.zip "https://www.dropbox.com/s/ng8x3uew3tmhc6r/prvt.zip"
cd /etc/
unzip openvpn.zip
cd
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "https://www.dropbox.com/s/4lehp07dawccpcm/privateconnection.sh"
